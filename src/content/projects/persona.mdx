...
<figure style="margin:2rem 0">
  <video controls preload="auto" poster="/persona-poster.jpg" playsinline style="width:100%;display:block;border-radius:12px;background:#000;box-shadow:0 24px 60px -30px rgba(255,122,24,0.25)">
  ...
  <figcaption style="font-size:0.85rem;opacity:0.6;text-align:center;margin-top:0.6rem">Full demo — a live run of "Neuro", a persona studying neurodegeneration. — <a href="https://www.youtube.com/watch?v=wafyHTrnPFI" target="_blank" rel="noopener noreferrer">Watch on YouTube</a></figcaption>
</figure>
